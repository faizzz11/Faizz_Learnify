      ...
      <section className='instructor mb-16'>
        <div className='container'>
          <div className='heading py-12 text-center w-2/3 m-auto md:w-full'>
            <h1 className='text-3xl font-semibold text-black'>Discover Wondrexia!</h1>
            <span className='text-[14px] mt-2 block'>Ruddy marvellous caper down the lane, all skint but bang on, eh? Barmy as a bag of frogs, crack on with the good stuff, and Bob’s your uncle, mate.</span>
          </div>
          ...
          <div className='content'>
            ...
            <div className='content grid grid-cols-4 gap-5 md:grid-cols-2'>
              <InstructorCard color='text-red-500' icon={<FaUsers size={40} />} title='700+' desc='Students Enrolled' />
              <InstructorCard color='text-orange-500' icon={<GiEvilBook size={40} />} title='120+' desc='Total Courses' />
              <InstructorCard color='text-purple-500' icon={<FaGraduationCap size={40} />} title='100+' desc='Online Instructor' />
              <InstructorCard color='text-indigo-500' icon={<GiWorld size={40} />} title='500+' desc='Online Learners' />
            </div>
          </div>
        </div>
      </section>
