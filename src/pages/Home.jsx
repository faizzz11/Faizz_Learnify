...
export const HomeContent = () => {
  return (
    <>
      <section className='bg-purple-300 py-10 h-[92vh] md:h-full'>
        <div className='container'>
          <div className='flex items-center justify-center md:flex-col'>
            <div className='left w-1/2 text-black md:w-full'>
              <h1 className='text-4xl leading-tight text-black font-semibold'>
              Build and launch your  <br />personalized e-learning <br /> Platform
              </h1>
              <h3 className='text-lg mt-3'>Learn from a curated selection of 100+ top instructors.</h3>
              <span className='text-[14px]'>Access every class with just ₹3999/-</span>
              ...
              <span className='text-[14px]'>Whatever you’re looking for, we’ve got you covered.</span>
            </div>
            <div className='right w-1/2 md:w-full relative'>
              ...
              <div className='content'>
                <button className='bg-white mt-[55px] shadow-md absolute top-56 left-0 z-30 p-2 flex items-center rounded-md'>
