      ...
      <footer className='bg-[#F3F4F8] py-10 pt-32 -mt-24'>
        <div className='container grid grid-cols-4 gap-5 md:grid-cols-2'>
          <div className='logo'>
            ...
            <span className='text-[14px]'>Amazing lesson plans and ideas for ESL educators! Teachers can adapt lessons to suit their students’ needs.</span>
          </div>

          <li>
            <h4 className='text-black text-sm font-semibold mb-5'>Company</h4>
            <NavLink to='https://www.instagram.com/faiz_moulavi11/' className=' text-[14px] block mb-2 '>
              Contact
            </NavLink>
            <NavLink to='https://www.linkedin.com/in/faiz-moulavi1/' className=' text-[14px] block mb-2'>
              Portfolio
            </NavLink>
            <NavLink to='https://www.instagram.com/faiz_moulavi11/' className=' text-[14px] block mb-2'>
              Blog
